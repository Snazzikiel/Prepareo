...
public class profileAdapter extends MultiLevelAdapter {
    ...
    private List<profileData> mListItems = new ArrayList<>();
    private profileData mItem;
    private MultiLevelRecyclerView mMultiLevelRecyclerView;

    profileAdapter(Context mContext, List<profileData> mListItems, MultiLevelRecyclerView mMultiLevelRecyclerView) {
        super(mListItems);
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new Holder(LayoutInflater.from(parent.getContext()).inflate(R.layout.profile_row_item, parent, false));
    }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        Log.e("ExpandLog",mItem.getLevel()+" "+mItem.getPosition()+" "+mItem.isExpanded()+"");
